function createTruckLoader(options = {}) {
  const {
    size = 'medium',
    containerId = null,
    truckColor = '#F83D3D',
  ...
  const sizeClass = size !== 'medium' ? ` truck-loader-${size}` : '';

  const truckHTML = `
    <div class="truck-loader${sizeClass}">
      <div class="truck-wrapper">
        <div class="truck-body">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 198 93" class="trucksvg">
            <!-- Main truck body -->
            <path stroke-width="3" stroke="#282828" fill="${truckColor}" d="M135 22.5H177.264C178.295 22.5 179.22 23.133 179.594 24.0939L192.33 56.8443C192.442 57.1332 192.5 57.4404 192.5 57.7504V89C192.5 90.3807 191.381 91.5 190 91.5H135C133.619 91.5 132.5 90.3807 132.5 89V25C132.5 23.6193 133.619 22.5 135 22.5Z"></path>
            <!-- Windows -->
            <path stroke-width="3" stroke="#282828" fill="${windowColor}" d="M146 33.5H181.741C182.779 33.5 183.709 34.1415 184.078 35.112L190.538 52.112C191.16 53.748 189.951 55.5 188.201 55.5H146C144.619 55.5 143.5 54.3807 143.5 53V36C143.5 34.6193 144.619 33.5 146 33.5Z"></path>
            <!-- Door handle -->
        ...
        ${showLampPost ? `
        <svg xml:space="preserve" viewBox="0 0 453.459 453.459" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" fill="#000000" class="truck-lamp-post">
...
// Expose globally
window.createTruckLoader = createTruckLoader; 